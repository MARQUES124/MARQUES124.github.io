    ...
    setTimeout(() => {
        ...
        setTimeout(() => {
            ...
            if (contextOptions) {
                ...
                // Fala a assertividade e a cor gerada com voz mais realista
                setTimeout(() => {
                    ...
                    voz.rate = 0.9;  // Velocidade ligeiramente reduzida
                    voz.pitch = 0.95; // Tom mais grave para realismo
                    voz.volume = 1; // Volume no máximo

                    speechSynthesis.speak(voz);
                }, 1200); // Pequeno atraso antes da fala para parecer mais natural
                ...
                setTimeout(() => {
                    if (contextOptions) {
                        ...
                        if (randomImageElement) {
                            ...
                            setTimeout(() => contextOptions.removeChild(randomImageElement), 1000);
                        }
                    }
                }, 7000);
            }
